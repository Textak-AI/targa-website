...
function NI(p){return(<div className="trg-nav" onClick={function(){setPage(p.pg);setSelItemCtx(null);}} style={{width:40,height:40,borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",background:page===p.pg?(p.pg==="cascade"?"#d6f0ee":C.tealBg):"transparent",cursor:"pointer"}} title={p.title}>{p.pg==="cascade"?<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M3 7.5 L12 12 L12 21 L3 16.5 Z" fill={C.teal}/><path d="M12 3 L21 7.5 L12 12 L3 7.5 Z" fill="#ffffff"/><path d="M21 7.5 L21 16.5 L12 21 L12 12 Z" fill="#db2777"/><path d="M12 3 L21 7.5 L21 16.5 L12 21 L3 16.5 L3 7.5 Z" fill="none" stroke={C.navy} strokeWidth="0.9" strokeLinejoin="round"/><path d="M3 7.5 L12 12 L21 7.5" stroke={C.navy} strokeWidth="0.9" strokeLinejoin="round" fill="none"/><path d="M12 12 L12 21" stroke={C.navy} strokeWidth="0.9"/></svg>:<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d={p.d} stroke={page===p.pg?C.teal:C.gray} strokeWidth="1.8" strokeLinecap="square"/></svg>}</div>);}
...
<NI pg="cascade" d="M4 5 L20 5 M4 12 L20 12 M6 19 L18 19" title="Strategy Map"/>
<NI pg="detail" d="M12 3 L12 21 M3 9 L21 9 M3 15 L21 15" title="Item Detail"/>
...
<div style={{display:"flex",alignItems:"center",gap:8,marginTop:16,paddingTop:14,borderTop:"1px solid "+C.subtle}}><Av i={s.owner} s={22}/><span style={{fontSize:13,fontWeight:500,color:C.navy}}>{s.name}</span><span style={{fontSize:12,color:C.gray}}>. {s.role}</span><span style={{marginLeft:"auto",fontSize:11,color:C.gray,letterSpacing:0.5,textTransform:"uppercase",fontWeight:500}}>{s.actions} actions</span></div>
</div>);})}
</div>
...
<div className="trg-cube-face right" style={{background:"linear-gradient(135deg, "+C.navy+" 0%, #0f2a3e 100%)"}}>
...
<div className="trg-cube-face left" style={{background:"linear-gradient(135deg, #db2777 0%, "+C.pinkDk+" 100%)"}}>
...
<div style={{fontFamily:"Space Grotesk, sans-serif",fontSize:22,fontWeight:500,color:C.navy,letterSpacing:"-0.015em",lineHeight:1.15,marginBottom:4}}>{cascadeView==="kanban"?"Kanban":cascadeView==="timeline"?"Timeline":cascadeView==="people"?"People":"Map"}</div>
...
<div style={{marginLeft:"auto"}}><Av i={s.owner} s={20}/></div>
</div>
...
<svg width="28" height="28" viewBox="0 0 24 24" fill="none"><rect x="5" y="6" width="10" height="2.5" fill="#fff"/><rect x="8" y="11" width="11" height="2.5" fill="#fff"/><rect x="4" y="16" width="7" height="2.5" fill="#fff"/></svg>
</div>
...
<svg width="28" height="28" viewBox="0 0 24 24" fill="none"><line x1="12" y1="12" x2="5" y2="5" stroke="#fff" strokeWidth="1.6" opacity="0.6"/><line x1="12" y1="12" x2="19" y2="5" stroke="#fff" strokeWidth="1.6" opacity="0.6"/><line x1="12" y1="12" x2="5" y2="19" stroke="#fff" strokeWidth="1.6" opacity="0.6"/><line x1="12" y1="12" x2="19" y2="19" stroke="#fff" strokeWidth="1.6" opacity="0.6"/><circle cx="12" cy="12" r="3" fill="#fff"/><circle cx="5" cy="5" r="2" fill="#fff"/><circle cx="19" cy="5" r="2" fill="#fff"/><circle cx="5" cy="19" r="2" fill="#fff"/><circle cx="19" cy="19" r="2" fill="#fff"/></svg>
</div>
...
<div style={{display:"flex",alignItems:"center",gap:10,marginBottom:8}}><div style={{width:8,height:8,borderRadius:"50%",background:s.sc==="green"?C.green:C.amber,flexShrink:0}}/><div style={{flex:1,fontSize:17,fontWeight:500,color:C.navy,minWidth:0}}>{s.t}</div><Av i={s.owner} s={20}/></div>
...
<div style={{display:"flex",alignItems:"center",gap:12,marginBottom:10,flexWrap:"wrap"}}><div style={{fontSize:17,fontWeight:500,color:C.navy,flex:1,minWidth:0}}>{b.t}</div><div style={{display:"flex",alignItems:"center",gap:8}}><Av i={b.owner} s={22}/><span style={{fontSize:13,color:C.gray,whiteSpace:"nowrap"}}>{b.name} . {b.role}</span></div><div style={{textAlign:"right"}}><div style={{fontSize:24,fontWeight:500,color:b.status==="green"?C.green:C.red}}>{b.conf}%</div><div style={{fontSize:12,color:b.conf>b.prev?C.green:C.red}}>{b.conf>b.prev?"\u2197 +":"\u2198 "}{Math.abs(b.conf-b.prev)} pts</div></div></div>
