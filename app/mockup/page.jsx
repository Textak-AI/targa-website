...
function NI(p){return(<div className="trg-nav" onClick={function(){setPage(p.pg);setSelItemCtx(null);}} style={{width:40,height:40,borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",background:page===p.pg?C.tealBg:"transparent",cursor:"pointer"}} title={p.title}>{p.pg==="cascade"?<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 3 L21 7.5 L21 16.5 L12 21 L3 16.5 L3 7.5 Z" fill="none" stroke={page===p.pg?C.navy:"#8b99a8"} strokeWidth="1.2" strokeLinejoin="miter"/><path d="M12 3 L12 21" stroke={page===p.pg?C.navy:"#8b99a8"} strokeWidth="1.2"/><path d="M3 7.5 L12 12 L21 7.5" stroke={page===p.pg?C.navy:"#8b99a8"} strokeWidth="1.2" strokeLinejoin="miter" fill="none"/><path d="M3 7.5 L12 12 L12 21 L3 16.5 Z" fill={C.teal} fillOpacity={page===p.pg?0.9:0.55}/><path d="M12 3 L21 7.5 L12 12 Z" fill={C.gold} fillOpacity={page===p.pg?0.9:0.55}/><path d="M21 7.5 L21 16.5 L12 21 L12 12 Z" fill="#db2777" fillOpacity={page===p.pg?0.9:0.55}/></svg>:<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d={p.d} stroke={page===p.pg?C.teal:C.gray} strokeWidth="1.8" strokeLinecap="square"/></svg>}</div>);}
