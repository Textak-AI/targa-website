...
/* ═══ PREMIUM BACKGROUND ═══ */
const HEX_PATTERN = "data:image/svg+xml," + encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" width="28" height="49"><path d="M14 0L28 8.5V24.5L14 33L0 24.5V8.5Z" fill="none" stroke="white" stroke-width="0.5" fill-opacity="0" stroke-opacity="0.03"/><path d="M14 16.5L28 25V41L14 49.5L0 41V25Z" fill="none" stroke="white" stroke-width="0.5" fill-opacity="0" stroke-opacity="0.03"/></svg>');
...
function PremiumBg({ children, orb1 = "rgba(139,92,246,0.07)", orb2 = "rgba(14,178,175,0.06)", style: sx = {} }) {
  ...
  return (
    <div ref={containerRef} style={{ position: "relative", overflow: "hidden", background: "#080e1a", ...sx }}>
      {/* Hex pattern */}
      <div style={{ position: "absolute", inset: 0, backgroundImage: "url(\"" + HEX_PATTERN + "\")", backgroundSize: "28px 49px", opacity: 1, pointerEvents: "none" }} />
      {/* Mouse gloss */}
